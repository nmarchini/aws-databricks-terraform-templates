...
resource "aws_iam_role_policy" "Databricks-E2-Cross-Account-Role_Databricks-E2-Cross-Account-Policy" {
  name   = "Databricks-E2-Cross-Account-Policy"
  role   = "Databricks-E2-Cross-Account-Role"
  policy = <<POLICY
{
  "Version": "2012-10-17",
  "Statement": [
    ...
    },
    {
      ...
      "Resource": "arn:aws:ec2:eu-west-1:${local.account_id}:security-group/sg-08a6004e",
      "Effect": "Allow",
